...
function setTime(){
    ...
    hour1.src = './assets/BTTH_icons/0'+Math.floor(hours/10)+'.gif'
    hour2.src = './assets/BTTH_icons/0'+Math.floor(hours%10)+'.gif'
    minute1.src = './assets/BTTH_icons/0'+Math.floor(minutes/10)+'.gif'
    minute2.src = './assets/BTTH_icons/0'+Math.floor(minutes%10)+'.gif'
    second1.src = './assets/BTTH_icons/0'+Math.floor(seconds/10)+'.gif'
    second2.src = './assets/BTTH_icons/0'+Math.floor(seconds%10)+'.gif'
